...
function flipThatCoin(result) {
  ...
  if (randomNumber === 0) {
    ...
    $("#coin-image").attr("src", "http://random-ize.com/coin-flip/us-quarter/us-quarter-front.jpg");
  }
  ...
  // Else
    ...
    $("#coin-image").attr("src", "http://random-ize.com/coin-flip/us-quarter/us-quarter-back.jpg");
  }
